...
export default function InputColors() {
    ...
    const [skinColor, setSkinColor] = useState<string | undefined>('#F8F7F4');
    const [hairColor, setHairColor] = useState<string | undefined>('#F8F7F4');
    const [eyeColor, setEyeColor] = useState<string | undefined>('#F8F7F4');
                ...
                <div className="flex flex-col w-1/2 mb-8">
                    ...
                    <div className="flex flex-col gap-8 items-center">
                        ...
                        <div className="flex flex-col self-start gap-10">
                            <PreferenceDiv heading="Color Intensity Preference" desc="Defines the intensity and vibrancy of the colors in the palette." options={["Bold", "Vibrant", "Muted", "Pastel", "Soft", "Neutral", "Classic", "Dark", "Earthy", "Warm"]} />


                            <PreferenceDiv heading="Seasonal Preferences" desc="Colors inspired by the mood and feel of each season." options={["Winter", "Spring", "Summer", "Autumn"]} />

                            <PreferenceDiv heading="Occasion-Based Preferences" desc="Find colors that fit the occasion, from casual to formal." options={["Casual", "Everyday", "Work", "Formal", "Vacation", "Festive", "Sports"]} />

                            <PreferenceDiv heading="Personal Style Preferences" desc="Match colors to your unique style, whether minimal or bold." options={["Minimalist", "Maximalist", "Modern", "Edgy", "Vintage", "Bohemian", "Classic", "Street"]} />
                        </div>
