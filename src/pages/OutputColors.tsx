    ...
    return (
        <>
            <div className="flex justify-center items-center bg-[#F8F7F4]">
                <div className="w-5/6 lg:w-3/4 m-2 py-4 lg:py-0 flex flex-col gap-8">
                    <div className="flex flex-col gap-12">
                        <h1 className="font-playfair text-5xl font-[400] text-[#0C111D]">Your Personalized Palette</h1>
                    ...
                    <div className="flex flex-col gap-8">
                        <div className="flex flex-col gap-4">
                            <h2 className="font-playfair font-[600] leading-5 text-2xl">Recommended Colors</h2>
